            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control cubex-input" id="exampleFormControlInput1"
                            placeholder="name . . ." name="name" value="{{ $full_name }}">
                    </div>
                </div>
                {{-- End  Name --}}
                {{-- Email --}}
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control cubex-input" id="exampleFormControlInput1"
                            placeholder="Email . . ." name="email" value="{{ $user_email }}">
                    </div>
                </div>
                {{-- End  Email --}}
                {{-- Password --}}
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control cubex-input" id="exampleFormControlInput1"
                            placeholder="Company . . ." name="company_id" value="{{ $user->company_id }}">
                    </div>
                </div>
                {{-- End  Company --}}
                {{-- Phone Number --}}
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control cubex-input" id="exampleFormControlInput1"
                            placeholder="Phone Number . . ." name="phone" value="{{ $user_phone }}">
                    </div>
                </div>
                {{-- End  Phone Number --}}
